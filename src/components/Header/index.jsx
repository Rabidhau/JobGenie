        ...
        <div className="flex flex-col mx-auto">
          <div className="relative flex flex-wrap items-center justify-between w-full bg-white group py-7 shrink-0">
            ...
            <div className="items-center justify-between hidden gap-12 text-black md:flex">
              ...
              >
                <Menu.Target>
                  <span className="text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900 cursor-pointer">
                    Jobs
                  </span>
                </Menu.Target>
                ...
                <Menu.Dropdown>
                  ...
                  <Menu.Item>Human Resource /Org. Development (17)</Menu.Item>
                </Menu.Dropdown>
              </Menu>
              <a
                className="text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900"
            ...
            <button onClick={toggleMenu} className="flex md:hidden">
              <a
                href="https://intellipaat.com/blog/what-is-job-portal/"
                target="_blank"
              >
                <svg
